...
// 			object.save(tifa);
			...
			totalTimeBeingUsed=totalTimeBeingUsed.plusMinutes(gettingReady+workoutTime+dinnerTime+lunchTime+mealTime+phoneTime+gettingReadyForSleep+sleepTime);
 	 			...
 	 			long totalMinutesUsedInADay=gettingReady+dinnerTime+lunchTime+workoutTime+mealTime+phoneTime+gettingReadyForSleep+sleepTime+goaltime+restTime;
	 		 	...
	 		 	while(goaltime>90)
	  	 		{
		  	 		if(goaltime-90>=60)
		  	 		{
		  	 			...
		  	 			{
		  	 			data.add(timeRn.toString()+" |  Take rest from "+timeRn.toString()+" to "+timeRn.plusMinutes(20));
		  	 			timeRn=timeRn.plusMinutes(20);
		  	 			restTime=restTime-20;
		  	 			
		  	 			data.add(timeRn.toString()+" |  Work on your goal: "+tifa.getGoal().toString());
	  	 			timeRn=timeRn.plusMinutes(90);
	  	 			goaltime=goaltime-90;
